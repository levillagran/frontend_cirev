...
export const Secuenciacion = () => {
    ...
    const saveSolicitud = () => {
        ...
        if (submitted) {
            ...
            request.shippingReceptionDate = dateValueSample.getDate() + '-' + (dateValueSample.getMonth() + 1) + '-' + dateValueSample.getFullYear();
            request.isShipping = isShipping;
            request.observationSequence = obsResult;
    ...
    const enterProcess = (request) => {
        async function getRequerimiento() {
            ...
            setObsResult(req.observationSecuence);
    ...
    const setIsShippingValue = (value) => {
        setIsShipping(value);
    };

    const onObsResultChange = (e) => {
                                ...
                                <div className="flex">
                                    ...
                                    <div className="col-10">
                                        ...
                                        <div className="formgroup-inline">
                                                ...
                                                <div className="flex">
                                                    <div className="col-12 md:col-6">
                                                        <div className="field-radiobutton">
                                                            <RadioButton inputId="option1" name="option" checked={isShipping} onChange={(e) => setIsShippingValue(true)} />
                                                            <label htmlFor="option1">Envío</label>
                                                        </div>
                                                    </div>
                                                    <div className="col-12 md:col-6">
                                                        <div className="field-radiobutton">
                                                            <RadioButton inputId="option2" name="option" checked={!isShipping} onChange={(e) => setIsShippingValue(false)} />
                                            ...
                                            <div className="col-2">
                                                <label htmlFor="dateReques">Fecha</label>
                                            ...
                                            <div className="col-4">
                                                ...
                                                <InputTextarea id="obser" value={obsResult} onChange={(e) => onObsResultChange(e)} rows={1} cols={20} autoResize />
                                            </div>
                                        </div>
                                    </div>
                                </div>
